...
public class RadiologyClaimProcessor extends MedicalClaimProcessor implements MessageListener
{

	private MessageProducer producer;

	public RadiologyClaimProcessor(Session session) {
		super(session, ProcedureCategory.Radiology);
	}
	...
	public void onMessage(Message message)
	{
	  ...
	  try {
		    ...
		    if(validateProcedure(claimFolder)) 
		    {
		    	...
		    	logger.debug("RadiologyClaimProcessor ProcedureValid");
		    ...
		    else
		    {
		    	...
		    	logger.debug("RadiologyClaimProcessor ProcedureInvalid");
